...
#define AI_NETWORK_MODEL_SIGNATURE     "0xd7ecac775088ac13db4a657a2b07258b"
...
#define AI_TOOLS_DATE_TIME   "2026-04-22T13:21:44+0200"
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_keras_tensor_50_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Tensor #12 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_keras_tensor_50_output, AI_STATIC,
  12, 0x0,
  AI_SHAPE_INIT(4, 1, 28, 1, 28), AI_STRIDE_INIT(4, 4, 4, 112, 112),
  1, &serving_default_keras_tensor_50_output_array, NULL)

/* Tensor #13 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_keras_tensor_50_output0, AI_STATIC,
  13, 0x0,
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_keras_tensor_50_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &gemm_4_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 435204, 1, 1),
    435204, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 3648, 1, 1),
    3648, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_keras_tensor_50_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &nl_7_output),
  &gemm_4_layer, 0x9891e283, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor_50_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    serving_default_keras_tensor_50_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    gemm_4_output_array.data = AI_PTR(g_network_activations_map[0] + 3136);
    gemm_4_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3136);
    ...
    gemm_5_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    gemm_5_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
    ...
    gemm_6_output_array.data = AI_PTR(g_network_activations_map[0] + 256);
    gemm_6_output_array.data_start = AI_PTR(g_network_activations_map[0] + 256);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_4_bias_array.data = AI_PTR(g_network_weights_map[0] + 401408);
    gemm_4_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 401408);
    gemm_5_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_weights_array.data = AI_PTR(g_network_weights_map[0] + 401920);
    gemm_5_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 401920);
    gemm_5_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_bias_array.data = AI_PTR(g_network_weights_map[0] + 434688);
    gemm_5_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 434688);
    gemm_6_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_6_weights_array.data = AI_PTR(g_network_weights_map[0] + 434944);
    gemm_6_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 434944);
    gemm_6_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_6_bias_array.data = AI_PTR(g_network_weights_map[0] + 435200);
    gemm_6_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 435200);
    return true;
  }
